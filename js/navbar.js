...
function insertNavbar() {
    ...
    <nav class="fixed w-full bg-white/90 backdrop-blur-md z-50 shadow-sm">
            ...
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden md:block">
                    <button id="cart-button-desktop" class="relative p-2 text-dark hover:text-secondary transition duration-300 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center ml-4">
                        ...
                        <span id="cart-count-desktop" class="absolute -top-2 -right-2 bg-primary text-dark text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">0</span>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white pb-4 px-4 shadow-lg">
            <div class="flex flex-col space-y-3">
                ...
                <button id="cart-button-mobile" class="w-full flex items-center justify-center text-dark font-medium hover:text-secondary px-3 py-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 mr-2"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
                    <span>Keranjang</span>
                    <span id="cart-count-mobile" class="ml-auto bg-primary text-dark text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">0</span>
                </button>
                <!-- Mobile auth buttons -->
    ...
    if (cartButtonDesktop) {
        cartButtonDesktop.addEventListener('click', window.openCart);
    }
