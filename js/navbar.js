                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-center space-x-8">
                        ...
                        <div id="user-profile" class="hidden relative">
                            ...
                            <div id="profile-dropdown" class="hidden absolute right-0 mt-3 w-64 bg-white border border-gray-100 rounded-2xl shadow-xl">
                                ...
                                <div class="py-2">
                                    <a href="profile.html" class="flex items-center gap-3 px-4 py-2 hover:bg-gray-50 text-gray-700">
                                        <i data-feather="user" class="w-4 h-4"></i>
                                        <span>Profile</span>
                                    </a>
                                    <a href="profiles.html" class="flex items-center gap-3 px-4 py-2 hover:bg-gray-50 text-gray-700">
                                        <i data-feather="tool" class="w-4 h-4"></i>
                                        <span>Become a Creator</span>
                                    </a>
                                    <a href="recent-activity.html" class="flex items-center gap-3 px-4 py-2 hover:bg-gray-50 text-gray-700">
                                        <i data-feather="file-text" class="w-4 h-4"></i>
                                        <span>Order History</span>
                                    </a>
                                    <a href="#" class="flex items-center gap-3 px-4 py-2 hover:bg-gray-50 text-gray-700">
